...
![[Pasted image 20251215162436.png]]
...
![[Pasted image 20251215162724.png]]

If we take a look at the `decrypt_flag` function, we see that it's impossible to force it to spill out the flag as it uses the user input to decrypt the flag with an AES-128-CBC cipher. Therefore, we need to understand and find what `check` needs to return 1.
![[Pasted image 20251215162846.png]]

Now, as you can see, `check` is just a (long) list of constraints that one must pass to get coveted 1.
![[Pasted image 20251215163052.png]]
...
![[Pasted image 20251215163111.png]]
